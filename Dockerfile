...
RUN \
    ...
    R -e 'install.packages("ggplot2");install.packages("plotly");' \
    R -e 'install.packages("dyplr");install.packages("openssl");devtools::install_github("niio972/opencpu-webapp")'
